...
function onEvent(name, value1, value2)
    if name == 'Lyrics_OP' then
		if value1 == '' then
			...
			doTweenAlpha('lyricInstanceA'..lyricNumber2, 'lyricInstance'..lyricNumber2, 0.5, 0.5, 'QuadOut')
			doTweenAlpha('lyricInstanceA'..lyricNumber3, 'lyricInstance'..lyricNumber3, 0.25, 0.5, 'QuadOut')
