function onEvent(name)
   if name == 'Note bruh' then
     ...
     noteTweenAngle('NoteAngle1', 4, la, 0.0001, cubeInOut);
     noteTweenAngle('NoteAngle2', 5, da, 0.0001, cubeInOut);
     noteTweenAngle('NoteAngle3', 6, ua, 0.0001, cubeInOut);
     noteTweenAngle('NoteAngle4', 7, ra, 0.0001, cubeInOut);
     ---Note moving to Y
